...
_.extend(Game.prototype, {
  ...
  getPick: function() {
    var pick = Picks.findOne({ gameId: this.eid.toString(), userId: Meteor.user()._id });
  ...
  getResult: function() {
    ...
    console.log("odds:", odds, "fav:", fav, "pick:", pick, "isFav:", isFav, "winning:", winning, "isPickCorrect:", isPickCorrect, "status:", status);
